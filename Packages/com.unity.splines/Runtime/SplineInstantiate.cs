    ...
    public class SplineInstantiate : SplineComponent
    {
        ...
        Transform instancesRootTransform
        {
            get
            {
                ...
                {
                    m_InstancesRoot = new GameObject(k_InstancesRootName+GetHashCode());
        ...
        void CheckChildrenValidity()
        {
            ...
            var ids = GetComponents<SplineInstantiate>().Select(sInstantiate => sInstantiate.GetHashCode()).ToList();
